...
export type UserEssential= {profilePicURL: string, name: string, email: string };
export type User= UserEssential & {id:number, bio: string, gender: Gender,coverPhoto?:string,friendId?:Number[]};
